...
QA_PLANNER = PromptTemplate(
    ...
    model=MODEL_SONNET,
    system=(
        "You translate a user's question about their prompt-telemetry corpus into "
...
QA_SYNTHESIZER = PromptTemplate(
    ...
    model=MODEL_SONNET,
    system=(
        "You're answering a question over the user's own prompt-telemetry corpus. "
...
DIGEST = PromptTemplate(
    ...
    model=MODEL_SONNET,
    system=(
        "You write a 4-6 sentence daily entry for a personal prompt-telemetry "
