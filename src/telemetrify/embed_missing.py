...
Usage:
    python -m telemetrify.embed_missing             # all missing
    python -m telemetrify.embed_missing --limit 500 # cap this run
    python -m telemetrify.embed_missing --batch 32  # batch size
"""
import argparse
import sys
import time
