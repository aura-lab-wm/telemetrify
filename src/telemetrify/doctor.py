"""Health-check & diagnostic report for the telemetrify pipeline.
...
def format_report(report: dict[str, Any]) -> str:
    ...
    lines.append(f"{_BOLD}telemetrify doctor{_RESET}  "
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="telemetrify-doctor",
        description="Health-check the telemetrify pipeline.",
    )
    parser.add_argument(
